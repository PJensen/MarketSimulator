...
namespace MarketSimulator.Events
{
    ...
    /// BuyEventArgs
    /// </summary>
    public class BuyEventArgs : MarketEventArgs
    {
        /// <summary>
        /// Createa  new BuyEventArgs with the specified quantity
        /// </summary>
        /// <param name="marketData">A reference to the market data</param>
        /// <param name="shares">The number of shares to purchase</param>
        public BuyEventArgs(MarketData marketData, int shares)
            : base(marketData)
        {
            Shares = shares;
        }
